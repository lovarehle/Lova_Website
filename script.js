...
const mediaItemsRaw = [
    ...
    { url: 'images/CBxVitra_postcards.jpg', caption: 'Collective Bakery × Vitra – Visual Identity, Postcards. Zürich. <br>Team: Ludvig Weingarten & Ramiro Oblitas'},
    { url: 'images/CBxVitra_vinyls.jpg', caption: 'Collective Bakery × Vitra – Visual Identity, Window Foil. Zürich. <br>Team: Ludvig Weingarten & Ramiro Oblitas' },
    { url: 'images/CBxVitra_Totebag.jpg', caption: 'Collective Bakery × Vitra – Visual Identity, Totebag. Zürich. <br>Team: Ludvig Weingarten & Ramiro Oblitas', fullViewport: true },
    ...
    { url: 'images/SGxKB-entrence.jpg', caption: 'OnceMore – Event Design. Konstnärshuset, Stockholm. <br>Team: Ramiro Oblitas', fullViewport: true},
    { url: 'images/SGxKB-9692-2.jpg', caption: 'OnceMore – Event Design. Konstnärshuset, Stockholm. <br>Team: Ramiro Oblitas', fullViewport: true},
    { url: 'images/bag_roots.jpg', caption: 'Roots – Visual Identity, Takeaway Bag. Zürich. <br>Team: Ludvig Weingarten & Ramiro Oblitas' },
    { url: 'images/Menuboard_roots.jpg', caption: 'Roots – Visual Identity, Menu Boards. Zürich. <br>Team: Ramiro Oblitas' },
    { url: 'images/roots_signage.jpg', caption: 'Roots – Visual Identity, Signage. Zürich. <br>Team: Ludvig Weingarten & Ramiro Oblitas'},
    { url: 'images/Roots_website.mp4', caption: 'Roots – Visual Identity, Website. Zürich. <br>Team: Ludvig Weingarten & Ramiro Oblitas' },
    { url: 'images/Rondo_scan_lowres.jpg', caption: 'Rondo – Broadsheet Magazine Design, #1. <br>Team: Ida Gustafsson, Anna Ericsson Hybbinette & Wasim Harwill' },
    { url: 'images/DSC08326_lowres.jpg', caption: 'Rondo – Broadsheet Magazine Design, #2. <br>Team: Ida Gustafsson, Anna Ericsson Hybbinette & Wasim Harwill'},
    { url: 'images/Rondo_frilagd.jpg', caption: 'Rondo – Broadsheet Magazine Design, #3. <br>Team: Ida Gustafsson, Anna Ericsson Hybbinette & Wasim Harwill' },
    ...
    { url: 'images/WoE_posters_.jpg', caption: 'Works of Essence – Visual Identity, Posters. <br>Team: Eliot Siekkinen Lydéen', fullViewport: true  },
